---
layout: default
title: Cert Import Driver
parent: Certdog
nav_order: 6
---
# Certdog Cert Import Driver

This component imports certificates from instances of ADCS (Active Directory Certificate Services)  
...
The driver requires access to the server API
...
The agent will check for jobs ever 5 seconds by default. To alter this, update the following environment variable:

CERTDOG_DRIVER_POLL_MILLISECS
